...
| **Potential TBC-backed prediction-market platform** | Digitally active Georgian retail users, especially users underserved by traditional brokerage but unwilling to use offshore betting/crypto platforms | Event-contract trading platform with revenue from spread/take rate, possible interest income on idle balances, and future data/insight products | Regulatory-first product design, bank-grade KYC/AML, local event design, mobile-first UX, transparent resolution rules | Could combine TBC trust and payment rails with prediction-market simplicity; first mover in regulated Georgian event contracts | Regulatory classification unresolved; reputational risk if perceived as gambling; liquidity cold-start problem; market-maker subsidy required |
...
The proposed platform should be placed in the upper-left quadrant if GEL-settled and bank-backed: digital-native architecture plus high regulatory integration. If launched as a USDC/VASP product, it shifts toward the upper-right quadrant: digital-native but more regulatory-flexible and crypto-native.

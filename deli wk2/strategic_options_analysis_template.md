...
| Justification | Directly leverages NBG sandbox framework and authority to define new services through normative acts. Aligns with 66% of Georgians who prefer short-term financial thinking and targets 92% without brokerage accounts through event-based contracts. | Addresses regulatory clarity through existing VASP framework but diverges from core thesis of GEL-denominated retail speculation. Better suited for international users than Georgian mainstream market. | Addresses user protection concerns but conflicts with evidence that Georgian consumers show low tolerance for friction. Artificial constraints may drive users to competitors offering unrestricted speculation. |
| Financial return (H/M/L) | High | Medium | Low |
| Justification | Kalshi precedent demonstrates $44B+ volume in regulated markets with sustainable take rates. DFS apps prove low-CAC user acquisition via referrals. TBC Capital's zero-commission, $1 minimum model validates micro-contract viability in Georgia. | Faster revenue path (6-9 months) but caps addressable market at crypto-literate users (5-10% of population). Mobile phone ownership exceeds financial account ownership, suggesting crypto approach excludes mainstream adoption. | Subscription model contradicts Georgian fintech revenue norms (transaction-based). 30% graduation assumption is speculative with no local precedent. Sacrifices short-term revenue for unproven long-term value. |
| Implementation feasibility (H/M/L) | Medium | High | Low |
| Justification | Requires NBG sandbox approval with 12-month timeline and GEL 1M deposit cap during testing. Paysera Georgia secured digital bank license showing pathway exists but timeline is uncertain. Requires payment provider partnerships. | VASP registration framework operational since July 2023 with clear requirements. 0% corporate tax on foreign IT services reduces fiscal complexity. No need for payment provider partnerships initially, reducing dependency risk. | Requires unprecedented bank partnerships for "graduation" referrals, but Georgian banks show limited retail fintech innovation and conservative approach to novel products. Educational content development is capital intensive. |
| Competitive defensibility (H/M/L) | High | Medium | Low |
| Justification | First-mover advantage in regulated Georgian prediction markets with NBG sandbox association creating trust barrier. No prediction market industry exists as of March 2026. Regulatory relationships and compliance infrastructure become moats against later entrants. | VASP registration provides compliance barrier but technology is replicable. Global platforms like Polymarket could theoretically serve Georgian users via VPN, though NBG supervision is increasing. Crypto-native positioning limits defensibility against international competitors with superior liquidity. | Responsible positioning is easily copied by competitors; loss limits and education are not proprietary. DFS apps already offer community features and responsible gaming tools. Subscription model creates switching costs but low retention if constraints feel punitive. |
...
1. **Regulatory pathway exists and is negotiable:** NBG Innovation Office explicitly accepts sandbox applications and has authority to define new virtual asset services through normative acts, creating a structured environment where prediction markets can secure bespoke classification as financial instruments rather than gambling.
2. **Market fit is validated by local and global evidence:** GEL-settled, mobile-first approach targets proven 60%+ mobile commerce penetration and 66% short-term financial preference in Georgia. TBC Capital's zero-commission, $1 fractional investing validates micro-contract viability, though differentiation must shift to product intuition rather than pure cost competition.
3. **Revenue model aligns with proven precedents:** Take rate plus interest income matches Kalshi and Polymarket global models and Georgian fintech transaction-based norms. Subscription model in Option 3 lacks local precedent and contradicts consumer preferences for transparent, usage-based pricing.

### Condition that would change this recommendation

If NBG explicitly refuses to classify event contracts as financial instruments during preliminary consultation (scheduled by 03/28/2026), forcing gambling law applicability with under-25 prohibition and advertising bans, then Option 2 becomes preferred to preserve market access, accepting the smaller addressable market and banking friction as necessary trade-offs for regulatory viability.

...
Positions the platform as a financial derivative tool for macroeconomic and civic outcomes (GEL/USD rates, local elections) to secure NBG sandbox approval. Settles in GEL through licensed payment providers (TBC Pay, Liberty Pay), avoiding gambling restrictions that prohibit users under 25 and ban advertising [[1]](https://www.gamingintelligence.com/regulation/georgia-tightens-gambling-regulations-further/). Emphasizes information aggregation, transparent probability pricing, and educational market making to secure classification as a financial instrument. 12-month sandbox period allows testing with up to GEL 1 million in customer deposits while building regulatory relationships before full licensing [[2]](https://www.nbg.gov.ge/en/pages/financial-innovation-office).
...
**Top risk:** Regulatory reclassification as gambling after launch, which would trigger GEL 15,000-30,000 fines, advertising bans, and exclusion of users under 25, devastating the target demographic [[1]](https://www.gamingintelligence.com/regulation/georgia-tightens-gambling-regulations-further/). **Mitigation:** Secure written NBG confirmation of financial instrument classification before public launch, potentially through a no-action letter or formal sandbox agreement that explicitly excludes gambling law applicability.
...
Launches as a VASP-registered platform using stablecoin settlement (USDC) under existing NBG virtual asset regulations, positioning event contracts as "prediction tokens" or convertible virtual assets [[5]](https://www.gfsis.org.ge/publications/georgia-s-cryptocurrency-regulation-landscape). Leverages Georgia's 0% corporate tax on foreign IT services [[6]](https://cointelegraph.com/news/georgia-crypto-regulation-vasp-registration) and mandatory VASP registration framework (effective July 2023) to operate with regulatory clarity while avoiding traditional securities law complexity. Fiat on-ramps flow through registered VASP partners or international payment processors, accepting that direct GEL integration is restricted. Targets crypto-native users and international participants, offering global event markets alongside Georgian-specific contracts, with blockchain settlement providing transparent, auditable outcomes.

### Financial logic 

Value creation derives from trading fees (taker-only, 0.5-1%), withdrawal fees, and potential token appreciation if the platform issues a utility token [[7]](https://www.guru99.com/polymarket-review.html). The key financial assumption is capturing 5% of Georgian crypto holders (estimated 50,000-100,000 based on regional penetration rates) plus international users seeking exposure to Georgian political and economic outcomes. ROI depends on maintaining blockchain infrastructure costs below $20,000 monthly and achieving $10 million monthly notional volume within 12 months. Requires $1-1.5 million in seed capital, with faster path to revenue (6-9 months) due to lighter regulatory burden, but caps total addressable market at crypto-literate users and faces banking relationship challenges for fiat conversion [[8]](https://www.worldbank.org/en/country/georgia/publication/financial-inclusion-national-survey-2022).

### Risk assessment 

**Top risk:** NBG expanding VASP restrictions to prohibit event-based virtual assets or restricting fiat off-ramps for prediction market winnings, effectively trapping user capital [[9]](https://www.gfsis.org.ge/publications/georgia-s-cryptocurrency-regulation-landscape). **Mitigation:** Diversify settlement rails across multiple stablecoins and maintain relationships with 3+ VASP partners to prevent single-point-of-failure, while proactively engaging NBG to confirm that prediction tokens fall within permitted "convertible virtual asset" definitions.
...
**Top risk:** User rejection of artificial constraints, with competitors offering unrestricted speculation capturing the 66% of Georgians who prefer short-term financial thinking [[11]](https://www.nbg.gov.ge/uploads/pressreleases/2025/Financial_Literacy_Survey_2024.pdf). **Mitigation:** A/B test loss limit thresholds during beta (starting at GEL 50, adjusting to GEL 150 based on retention data) and offer "challenge modes" that unlock higher limits after educational completion, preserving responsible positioning while accommodating user preferences.
...
| Justification | Directly leverages NBG sandbox framework [[2]](https://www.nbg.gov.ge/en/pages/financial-innovation-office) and authority to define new services through normative acts [[12]](https://www.nbg.gov.ge/uploads/pressreleases/2025/Amendments_to_the_Law_on_Operating_of_the_Virtual_Assets.pdf). Aligns with 66% of Georgians who prefer short-term financial thinking [[11]](https://www.nbg.gov.ge/uploads/pressreleases/2025/Financial_Literacy_Survey_2024.pdf) and targets 92% without brokerage accounts [[10]](https://gse.ge/Uploads/2024%20Annual%20Report.pdf) through event-based contracts. | Addresses regulatory clarity through existing VASP framework [[5]](https://www.gfsis.org.ge/publications/georgia-s-cryptocurrency-regulation-landscape) but diverges from core thesis of GEL-denominated retail speculation. Better suited for international users than Georgian mainstream market [[8]](https://www.worldbank.org/en/country/georgia/publication/financial-inclusion-national-survey-2022). | Addresses user protection concerns but conflicts with evidence that Georgian consumers show low tolerance for friction [[13]](https://www.geostat.ge/media/uploads/files/economy/ICT%20Usage%20in%20Households%20and%20by%20Individuals%202023.pdf). Artificial constraints may drive users to competitors offering unrestricted speculation [[11]](https://www.nbg.gov.ge/uploads/pressreleases/2025/Financial_Literacy_Survey_2024.pdf). |
| Financial return (H/M/L) | High | Medium | Low |
| Justification | Kalshi precedent demonstrates $44B+ volume in regulated markets with sustainable take rates [[14]](https://www.theblock.co/post/331953/kalshi-raises-50-million-at-20-billion-valuation)[[15]](https://www.bloomberg.com/news/articles/2025-11-14/kalshi-raises-50-million-at-20-billion-valuation). DFS apps prove low-CAC user acquisition via referrals [[4]](https://www.bloomberg.com/news/articles/2025-10-28/draftkings-and-fanduel-face-new-challengers-in-daily-fantasy-sports). TBC Capital's zero-commission, $1 minimum model validates micro-contract viability in Georgia [[16]](https://www.tbcbank.ge/en/corporate/tbc-capital/tbc-capital-individuals). | Faster revenue path (6-9 months) but caps addressable market at crypto-literate users (5-10% of population). Mobile phone ownership exceeds financial account ownership, suggesting crypto approach excludes mainstream adoption [[8]](https://www.worldbank.org/en/country/georgia/publication/financial-inclusion-national-survey-2022). | Subscription model contradicts Georgian fintech revenue norms (transaction-based). 30% graduation assumption is speculative with no local precedent. Sacrifices short-term revenue for unproven long-term value. |
| Implementation feasibility (H/M/L) | Medium | High | Low |
| Justification | Requires NBG sandbox approval with 12-month timeline and GEL 1M deposit cap during testing [[2]](https://www.nbg.gov.ge/en/pages/financial-innovation-office). Paysera Georgia secured digital bank license showing pathway exists but timeline is uncertain. Requires payment provider partnerships. | VASP registration framework operational since July 2023 with clear requirements [[5]](https://www.gfsis.org.ge/publications/georgia-s-cryptocurrency-regulation-landscape). 0% corporate tax on foreign IT services reduces fiscal complexity [[6]](https://cointelegraph.com/news/georgia-crypto-regulation-vasp-registration). No need for payment provider partnerships initially, reducing dependency risk. | Requires unprecedented bank partnerships for "graduation" referrals, but Georgian banks show limited retail fintech innovation and conservative approach to novel products [[17]](https://www.galtandtaggart.com/ge/wealth-management/brokerage). Educational content development is capital intensive. |
...
1. **Regulatory pathway exists and is negotiable:** NBG Innovation Office explicitly accepts sandbox applications [[2]](https://www.nbg.gov.ge/en/pages/financial-innovation-office) and has authority to define new virtual asset services through normative acts [[12]](https://www.nbg.gov.ge/uploads/pressreleases/2025/Amendments_to_the_Law_on_Operating_of_the_Virtual_Assets.pdf), creating a structured environment where prediction markets can secure bespoke classification as financial instruments rather than gambling.
2. **Market fit is validated by local and global evidence:** GEL-settled, mobile-first approach targets proven 60%+ mobile commerce penetration [[13]](https://www.geostat.ge/media/uploads/files/economy/ICT%20Usage%20in%20Households%20and%20by%20Individuals%202023.pdf) and 66% short-term financial preference in Georgia [[11]](https://www.nbg.gov.ge/uploads/pressreleases/2025/Financial_Literacy_Survey_2024.pdf). TBC Capital's zero-commission, $1 fractional investing validates micro-contract viability [[16]](https://www.tbcbank.ge/en/corporate/tbc-capital/tbc-capital-individuals), though differentiation must shift to product intuition rather than pure cost competition.
3. **Revenue model aligns with proven precedents:** Take rate plus interest income matches Kalshi and Polymarket global models [[3]](https://www.kalshi.com/)[[7]](https://www.guru99.com/polymarket-review.html) and Georgian fintech transaction-based norms. Subscription model in Option 3 lacks local precedent and contradicts consumer preferences for transparent, usage-based pricing.

### Condition that would change this recommendation

If NBG explicitly refuses to classify event contracts as financial instruments during preliminary consultation (scheduled by 03/28/2026), forcing gambling law applicability with under-25 prohibition and advertising bans [[1]](https://www.gamingintelligence.com/regulation/georgia-tightens-gambling-regulations-further/), then Option 2 becomes preferred to preserve market access, accepting the smaller addressable market and banking friction as necessary trade-offs for regulatory viability.

...
| **B** | **Event Relevance & Local Markets** | Georgian-specific events (elections, regional sports, macro indicators) vs. generic US stocks. *Evidence: 66% short-term preference; TBC Capital offers 6,000+ US stocks but lacks local event exposure* |
...
| **B** | **Embedded Finance & Partnerships** | PSP integrations (CityPay.io, Payze, local banks), merchant partnerships, media outlet collaborations for event sponsorship. A bank-backed route could reduce customer acquisition costs by embedding the product into an existing banking or mobile-payment ecosystem, but it also increases reputational and compliance scrutiny. |
...
|       | Sub-driver                             | Description                                                                                                                                                                                                                      |
| ----- | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A** | **Regulatory Classification Pathway**  | NBG sandbox entry for "innovative payment service" vs. gambling commission route, legal opinion on event contracts as derivatives vs. betting. A TBC-backed platform may be more credible to NBG and payment partners than a standalone startup, but bank involvement also raises the standard for consumer protection, market integrity, and public optics. *Evidence: NBG has authority to define virtual asset services via normative acts* |
